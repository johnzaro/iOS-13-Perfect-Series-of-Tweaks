#include "PALRootListController.h"
#import "spawn.h"
...
@implementation PALRootListController
...
- (instancetype)init
{
    ...
    if (self)
	{
        PALAppearanceSettings *appearanceSettings = [[PALAppearanceSettings alloc] init];
        ...
        self.titleLabel.text = @"PerfectAlerts";
...
{
    if (scrollView.contentOffset.y > [PALRootHeaderView headerH] / 2.0) [UIView animateWithDuration: 0.2 animations: ^{ self.titleLabel.alpha = 1.0; }];
